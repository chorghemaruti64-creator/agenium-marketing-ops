 ...
 */
export function checkHateHarassment(text: string): boolean {
 ...
 */
export function checkSexualContent(text: string): boolean {
 ...
 */
export function checkDoxxing(text: string): boolean {
 ...
 */
export function checkIllegalInstructions(text: string): boolean {
 ...
 */
export function checkPoliticalTargeting(text: string): boolean {
 ...
 */
export function hasBrandMention(text: string): boolean {
 ...
 */
export function hasNumericClaims(text: string): boolean {
 ...
 */
export function requiresBrandMention(actionType: ActionType): boolean {
 ...
 */
export function allowedDuringQuietHours(actionType: ActionType): boolean {
 ...
 */
export function runSafetyChecks(action: PlatformAction): ReasonCode[] {
  const violations: ReasonCode[] = [];
 ...
 */
export function checkBrandCompliance(action: PlatformAction): ReasonCode | null {
 ...
 */
export function checkEvidenceRequirement(action: PlatformAction): ReasonCode | null {
