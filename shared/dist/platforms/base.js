...
import { logPolicyDecision, logPlatformAttempt, logPlatformResult, logError, } from '../moltbook/ledger.js';
/**
 * Wraps a platform-specific execute function with policy + Moltbook
 */
export async function executeWithPolicy(action, config, executeFn) {
 ...
 */
export async function isCircuitOpen(storeDb, platform) {
