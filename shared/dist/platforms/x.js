 ...
 */
function generateOAuthSignature(method, url, params, creds) {
 ...
 */
function buildOAuthHeader(method, url, creds, extraParams = {}) {
    const oauthParams = {
...
async function executeX(action, config) {
...
export async function postToX(action, config) {
